...
#define EXTRUDER_0_AUTO_FAN_PIN    7  // MKS_GEN_L
...
// Motor Current settings for MKS GEN L PWM value = MotorCurrentSetting * 255 / range
#if MOTHERBOARD == BOARD_MKS_GEN_L // It doesn't matter for A9800 drivers
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER   -0.4   //-0,4  // Z probe to nozzle Z offset: -below (always!)
#endif
...
#else
#define TEMP_SENSOR_0 13 //5 for Original Prusa
#endif
